# GET /people/{person_id}/schedules/{schedule_id}/declined_plan_times/{declined_plan_time_id}

**Resource:** [Person](../resources/Person.md)
**Operation ID:** `get--people-{person_id}-schedules-{schedule_id}-declined_plan_times-{declined_plan_time_id}`
