# PATCH /songs/{song_id}/arrangements/{arrangement_id}/attachments/{attachment_id}

**Resource:** [Song](../resources/Song.md)
**Operation ID:** `patch--songs-{song_id}-arrangements-{arrangement_id}-attachments-{attachment_id}`
