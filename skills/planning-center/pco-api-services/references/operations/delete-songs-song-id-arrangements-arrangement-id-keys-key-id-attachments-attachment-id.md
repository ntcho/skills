# DELETE /songs/{song_id}/arrangements/{arrangement_id}/keys/{key_id}/attachments/{attachment_id}

**Resource:** [Song](../resources/Song.md)
**Operation ID:** `delete--songs-{song_id}-arrangements-{arrangement_id}-keys-{key_id}-attachments-{attachment_id}`
