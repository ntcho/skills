# PATCH /service_types/{service_type_id}/plan_templates/{plan_template_id}/team_members/{team_member_id}

**Resource:** [ServiceType](../resources/ServiceType.md)
**Operation ID:** `patch--service_types-{service_type_id}-plan_templates-{plan_template_id}-team_members-{team_member_id}`
