# GET /people/{person_id}/plan_people/{plan_person_id}/plan_times/{plan_time_id}

**Resource:** [Person](../resources/Person.md)
**Operation ID:** `get--people-{person_id}-plan_people-{plan_person_id}-plan_times-{plan_time_id}`
