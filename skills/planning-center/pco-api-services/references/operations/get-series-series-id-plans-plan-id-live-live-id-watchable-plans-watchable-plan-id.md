# GET /series/{series_id}/plans/{plan_id}/live/{live_id}/watchable_plans/{watchable_plan_id}

**Resource:** [Series](../resources/Series.md)
**Operation ID:** `get--series-{series_id}-plans-{plan_id}-live-{live_id}-watchable_plans-{watchable_plan_id}`
