# PATCH /series/{series_id}/plans/{plan_id}/needed_positions/{needed_position_id}/time/{time_id}

**Resource:** [Series](../resources/Series.md)
**Operation ID:** `patch--series-{series_id}-plans-{plan_id}-needed_positions-{needed_position_id}-time-{time_id}`
