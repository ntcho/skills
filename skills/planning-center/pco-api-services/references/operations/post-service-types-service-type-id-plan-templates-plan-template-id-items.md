# POST /service_types/{service_type_id}/plan_templates/{plan_template_id}/items

**Resource:** [ServiceType](../resources/ServiceType.md)
**Operation ID:** `post--service_types-{service_type_id}-plan_templates-{plan_template_id}-items`
