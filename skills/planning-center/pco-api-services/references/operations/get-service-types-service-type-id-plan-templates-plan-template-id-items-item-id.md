# GET /service_types/{service_type_id}/plan_templates/{plan_template_id}/items/{item_id}

**Resource:** [ServiceType](../resources/ServiceType.md)
**Operation ID:** `get--service_types-{service_type_id}-plan_templates-{plan_template_id}-items-{item_id}`
