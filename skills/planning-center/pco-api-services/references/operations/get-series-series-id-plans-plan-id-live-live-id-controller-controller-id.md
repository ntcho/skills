# GET /series/{series_id}/plans/{plan_id}/live/{live_id}/controller/{controller_id}

**Resource:** [Series](../resources/Series.md)
**Operation ID:** `get--series-{series_id}-plans-{plan_id}-live-{live_id}-controller-{controller_id}`
