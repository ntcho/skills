# DELETE /resource_approval_groups/{resource_approval_group_id}/resources/{resource_id}

**Resource:** [ResourceApprovalGroup](../resources/ResourceApprovalGroup.md)
**Operation ID:** `delete--resource_approval_groups-{resource_approval_group_id}-resources-{resource_id}`
