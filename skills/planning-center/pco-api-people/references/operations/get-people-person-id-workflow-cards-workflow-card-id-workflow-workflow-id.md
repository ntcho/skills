# GET /people/{person_id}/workflow_cards/{workflow_card_id}/workflow/{workflow_id}

**Resource:** [Person](../resources/Person.md)
**Operation ID:** `get--people-{person_id}-workflow_cards-{workflow_card_id}-workflow-{workflow_id}`
