# PATCH /lists/{list_id}/rules/{rule_id}/conditions/{condition_id}/created_by/{created_by_id}

**Resource:** [List](../resources/List.md)
**Operation ID:** `patch--lists-{list_id}-rules-{rule_id}-conditions-{condition_id}-created_by-{created_by_id}`
