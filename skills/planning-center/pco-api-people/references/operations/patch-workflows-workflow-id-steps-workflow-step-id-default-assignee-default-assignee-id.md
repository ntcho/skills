# PATCH /workflows/{workflow_id}/steps/{workflow_step_id}/default_assignee/{default_assignee_id}

**Resource:** [Workflow](../resources/Workflow.md)
**Operation ID:** `patch--workflows-{workflow_id}-steps-{workflow_step_id}-default_assignee-{default_assignee_id}`
