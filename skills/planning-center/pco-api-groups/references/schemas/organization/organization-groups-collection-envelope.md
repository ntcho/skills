# organization-groups-collection-envelope
...
| `can_filter` | enum: campus,enrollment,group,group_type,hidden,meeting_schedule,my_groups,people_database_searchable,published,tag | No |  |
